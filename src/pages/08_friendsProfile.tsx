      ...
      <div className='space-y-16'>
        ...
        <div className='flex justify-between'>
          ...
          <div className='flex items-center space-x-12'>
            {/* Edit profile */}
            <div className='relative flex h-48 w-130'>
              <Check className='absolute top-14 left-16 h-20 w-20 rounded-full border border-white p-1' />
              <Button className='md:text-md h-48 w-130 border border-[#181D27] pl-20 text-sm font-bold hover:cursor-pointer'>
                Following
              </Button>
            </div>
            {/* Send */}
